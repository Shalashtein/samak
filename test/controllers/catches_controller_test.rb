...
class CatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catch" do
    assert_difference('Catch.count') do
      post catches_url, params: { catch: { fish_id: @catch.fish_id, user_id: @catch.user_id, weight: @catch.weight } }
    end
  ...
  test "should update catch" do
    patch catch_url(@catch), params: { catch: { fish_id: @catch.fish_id, user_id: @catch.user_id, weight: @catch.weight } }
