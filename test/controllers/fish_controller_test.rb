...
class FishControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fish" do
    assert_difference('Fish.count') do
      post fish_index_url, params: { fish: { english: @fish.english, flavor: @fish.flavor, image: @fish.image, lebanese: @fish.lebanese, scientific: @fish.scientific, texture: @fish.texture, water: @fish.water } }
    end
  ...
  test "should update fish" do
    patch fish_url(@fish), params: { fish: { english: @fish.english, flavor: @fish.flavor, image: @fish.image, lebanese: @fish.lebanese, scientific: @fish.scientific, texture: @fish.texture, water: @fish.water } }
